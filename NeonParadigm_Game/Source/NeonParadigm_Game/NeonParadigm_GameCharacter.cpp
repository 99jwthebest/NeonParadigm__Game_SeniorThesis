...
void ANeonParadigm_GameCharacter::TimerCameraFOV(float TargetFOVValue, float CameraFovSpeedChangeF)
{
	TargetCameraFOV = TargetFOVValue;
	CameraFOVSpeedChange = CameraFovSpeedChangeF;
	GetWorld()->GetTimerManager().SetTimer(
		TimerForFOVChange,
		this,
...
void ANeonParadigm_GameCharacter::ChangeCameraFOV()
{
	...
	FollowCamera->FieldOfView = FMath::FInterpTo(
		...
		TargetCameraFOV,
		GetWorld()->GetDeltaSeconds(),
		CameraFOVSpeedChange // Interpolation speed, adjust as needed
	);
