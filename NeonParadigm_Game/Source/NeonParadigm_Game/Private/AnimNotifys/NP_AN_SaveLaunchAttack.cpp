...
#include "AnimNotifys/NP_AN_SaveLaunchAttack.h"
#include "NeonParadigm_Game/Components/AttackComponent.h"


void UNP_AN_SaveLaunchAttack::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
