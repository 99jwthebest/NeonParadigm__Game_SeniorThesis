...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_NeonParadigm_Game_EDamageTypes_Statics::Enumerators[] = {
		...
		{ "EDamageTypes::Stun", (int64)EDamageTypes::Stun },
		{ "EDamageTypes::Projectiles", (int64)EDamageTypes::Projectiles },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_NeonParadigm_Game_EDamageTypes_Statics::Enum_MetaDataParams[] = {
		...
		{ "Projectiles.Comment", "//UMETA(DisplayName = \"Option 5\"),\n" },
		{ "Projectiles.Name", "EDamageTypes::Projectiles" },
		{ "Projectiles.ToolTip", "UMETA(DisplayName = \"Option 5\")," },
		{ "Right.Comment", "/**\n * \n *///UMETA(DisplayName = \"Option 1\"),\n" },
		{ "Right.Name", "EDamageTypes::Right" },
		{ "Right.ToolTip", "//UMETA(DisplayName = \"Option 1\")," },
		{ "Stun.Comment", "//UMETA(DisplayName = \"Option 5\"),\n" },
		{ "Stun.Name", "EDamageTypes::Stun" },
		{ "Stun.ToolTip", "UMETA(DisplayName = \"Option 5\")," },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_Statics::EnumInfo[] = {
		{ EDamageTypes_StaticEnum, TEXT("EDamageTypes"), &Z_Registration_Info_UEnum_EDamageTypes, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1041548161U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNP_DamageType, UNP_DamageType::StaticClass, TEXT("UNP_DamageType"), &Z_Registration_Info_UClass_UNP_DamageType, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNP_DamageType), 905801452U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_882737801(TEXT("/Script/NeonParadigm_Game"),
		Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID__J_Hernandez_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_DamageType_NP_DamageType_h_Statics::EnumInfo));
