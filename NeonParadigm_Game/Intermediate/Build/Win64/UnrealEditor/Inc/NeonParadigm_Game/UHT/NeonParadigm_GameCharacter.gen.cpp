...
// End Cross Module References
	...
	DEFINE_FUNCTION(ANeonParadigm_GameCharacter::execIncreaseMaxHealth)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_AmountToAdd);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->IncreaseMaxHealth(Z_Param_AmountToAdd);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(ANeonParadigm_GameCharacter::execIncreaseMaxRage)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_AmountToAdd);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->IncreaseMaxRage(Z_Param_AmountToAdd);
		P_NATIVE_END;
	}
	...
	static FName NAME_ANeonParadigm_GameCharacter_SpawnWinMenuEvent = FName(TEXT("SpawnWinMenuEvent"));
	void ANeonParadigm_GameCharacter::SpawnWinMenuEvent()
	{
		ProcessEvent(FindFunctionChecked(NAME_ANeonParadigm_GameCharacter_SpawnWinMenuEvent),NULL);
	}
	...
	static FName NAME_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent = FName(TEXT("UpdateDodgeBarEvent"));
	void ANeonParadigm_GameCharacter::UpdateDodgeBarEvent()
	{
		ProcessEvent(FindFunctionChecked(NAME_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent),NULL);
	}
	...
	static FName NAME_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent = FName(TEXT("UpdateMaxHealthBarEvent"));
	void ANeonParadigm_GameCharacter::UpdateMaxHealthBarEvent()
	{
		ProcessEvent(FindFunctionChecked(NAME_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent),NULL);
	}
	static FName NAME_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent = FName(TEXT("UpdateMaxRageBarEvent"));
	void ANeonParadigm_GameCharacter::UpdateMaxRageBarEvent()
	{
		ProcessEvent(FindFunctionChecked(NAME_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent),NULL);
	}
	...
	static FName NAME_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent = FName(TEXT("UpdateProjectileWeaponStunBarEvent"));
	void ANeonParadigm_GameCharacter::UpdateProjectileWeaponStunBarEvent()
	{
		ProcessEvent(FindFunctionChecked(NAME_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent),NULL);
	}
	...
	void ANeonParadigm_GameCharacter::StaticRegisterNativesANeonParadigm_GameCharacter()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "IncreaseMaxHealth", &ANeonParadigm_GameCharacter::execIncreaseMaxHealth },
			{ "IncreaseMaxRage", &ANeonParadigm_GameCharacter::execIncreaseMaxRage },
	...
	struct Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics
	{
		struct NeonParadigm_GameCharacter_eventIncreaseMaxHealth_Parms
		{
			float AmountToAdd;
		};
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::NewProp_AmountToAdd = { "AmountToAdd", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NeonParadigm_GameCharacter_eventIncreaseMaxHealth_Parms, AmountToAdd), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::NewProp_AmountToAdd,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANeonParadigm_GameCharacter, nullptr, "IncreaseMaxHealth", nullptr, nullptr, Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::PropPointers), sizeof(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::NeonParadigm_GameCharacter_eventIncreaseMaxHealth_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::NeonParadigm_GameCharacter_eventIncreaseMaxHealth_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics
	{
		struct NeonParadigm_GameCharacter_eventIncreaseMaxRage_Parms
		{
			float AmountToAdd;
		};
		static const UECodeGen_Private::FFloatPropertyParams NewProp_AmountToAdd;
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::NewProp_AmountToAdd = { "AmountToAdd", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NeonParadigm_GameCharacter_eventIncreaseMaxRage_Parms, AmountToAdd), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::NewProp_AmountToAdd,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANeonParadigm_GameCharacter, nullptr, "IncreaseMaxRage", nullptr, nullptr, Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::PropPointers), sizeof(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::NeonParadigm_GameCharacter_eventIncreaseMaxRage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::NeonParadigm_GameCharacter_eventIncreaseMaxRage_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANeonParadigm_GameCharacter, nullptr, "SpawnWinMenuEvent", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANeonParadigm_GameCharacter, nullptr, "UpdateDodgeBarEvent", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANeonParadigm_GameCharacter, nullptr, "UpdateMaxHealthBarEvent", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANeonParadigm_GameCharacter, nullptr, "UpdateMaxRageBarEvent", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANeonParadigm_GameCharacter, nullptr, "UpdateProjectileWeaponStunBarEvent", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ProjectileWeaponStunAction_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_ProjectileWeaponStunAction;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DodgeCooldownProgress_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_DodgeCooldownProgress;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ProjectileWeaponStunMontage_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_ProjectileWeaponStunMontage;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CooldownProjectileStunDuration_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_CooldownProjectileStunDuration;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ProjectileStunCooldownProgress_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ProjectileStunCooldownProgress;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxHealth, "IncreaseMaxHealth" }, // 2295941456
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_IncreaseMaxRage, "IncreaseMaxRage" }, // 2576072361
		...
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_SpawnWinMenuEvent, "SpawnWinMenuEvent" }, // 1869716497
		...
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateDodgeBarEvent, "UpdateDodgeBarEvent" }, // 2203321580
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateHealthBarEvent, "UpdateHealthBarEvent" }, // 733924716
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxHealthBarEvent, "UpdateMaxHealthBarEvent" }, // 761681618
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateMaxRageBarEvent, "UpdateMaxRageBarEvent" }, // 2716387833
		...
		{ &Z_Construct_UFunction_ANeonParadigm_GameCharacter_UpdateProjectileWeaponStunBarEvent, "UpdateProjectileWeaponStunBarEvent" }, // 47518148
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunAction_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Input" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Projectile Weapon Input Action */" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunAction = { "ProjectileWeaponStunAction", nullptr, (EPropertyFlags)0x0040000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANeonParadigm_GameCharacter, ProjectileWeaponStunAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunAction_MetaData), Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunAction_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_DodgeCooldownProgress_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Projectile" },
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_DodgeCooldownProgress = { "DodgeCooldownProgress", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANeonParadigm_GameCharacter, DodgeCooldownProgress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_DodgeCooldownProgress_MetaData), Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_DodgeCooldownProgress_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunMontage_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Attack" },
		{ "ModuleRelativePath", "NeonParadigm_GameCharacter.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunMontage = { "ProjectileWeaponStunMontage", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANeonParadigm_GameCharacter, ProjectileWeaponStunMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunMontage_MetaData), Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunMontage_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_CooldownProjectileStunDuration_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Projectile" },
#if !UE_BUILD_SHIPPING
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_CooldownProjectileStunDuration = { "CooldownProjectileStunDuration", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANeonParadigm_GameCharacter, CooldownProjectileStunDuration), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_CooldownProjectileStunDuration_MetaData), Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_CooldownProjectileStunDuration_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileStunCooldownProgress_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Projectile" },
#if !UE_BUILD_SHIPPING
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileStunCooldownProgress = { "ProjectileStunCooldownProgress", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANeonParadigm_GameCharacter, ProjectileStunCooldownProgress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileStunCooldownProgress_MetaData), Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileStunCooldownProgress_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunAction,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_DodgeCooldownProgress,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileWeaponStunMontage,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_CooldownProjectileStunDuration,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANeonParadigm_GameCharacter_Statics::NewProp_ProjectileStunCooldownProgress,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_josep_Documents_Unreal_Projects_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_NeonParadigm_GameCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANeonParadigm_GameCharacter, ANeonParadigm_GameCharacter::StaticClass, TEXT("ANeonParadigm_GameCharacter"), &Z_Registration_Info_UClass_ANeonParadigm_GameCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANeonParadigm_GameCharacter), 75993301U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_josep_Documents_Unreal_Projects_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_NeonParadigm_GameCharacter_h_3391313917(TEXT("/Script/NeonParadigm_Game"),
