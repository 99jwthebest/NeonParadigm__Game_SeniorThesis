...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TargetRadius_MetaData[];
#endif
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNP_AN_SoftTarget_Statics::NewProp_TargetRadius_MetaData[] = {
		{ "Category", "Soft Target" },
		{ "ModuleRelativePath", "AnimNotify/NP_AN_SoftTarget.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNP_AN_SoftTarget_Statics::NewProp_TargetRadius = { "TargetRadius", nullptr, (EPropertyFlags)0x0040000000000011, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNP_AN_SoftTarget, TargetRadius), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNP_AN_SoftTarget_Statics::NewProp_TargetRadius_MetaData), Z_Construct_UClass_UNP_AN_SoftTarget_Statics::NewProp_TargetRadius_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNP_AN_SoftTarget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNP_AN_SoftTarget_Statics::NewProp_TargetRadius,
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_drake_Documents_GitHub_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_AnimNotify_NP_AN_SoftTarget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_drake_Documents_GitHub_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_AnimNotify_NP_AN_SoftTarget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNP_AN_SoftTarget, UNP_AN_SoftTarget::StaticClass, TEXT("UNP_AN_SoftTarget"), &Z_Registration_Info_UClass_UNP_AN_SoftTarget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNP_AN_SoftTarget), 4040728516U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_drake_Documents_GitHub_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_AnimNotify_NP_AN_SoftTarget_h_2886914521(TEXT("/Script/NeonParadigm_Game"),
		Z_CompiledInDeferFile_FID_Users_drake_Documents_GitHub_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_AnimNotify_NP_AN_SoftTarget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_drake_Documents_GitHub_NeonParadigm__Game_SeniorThesis_NeonParadigm_Game_Source_NeonParadigm_Game_AnimNotify_NP_AN_SoftTarget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
